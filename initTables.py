...
def initSQLTables(dbPath, packetType):
    ...
    if packetType == SolverCode.BGK:
        ...
        dropReqString = "DROP TABLE IF EXISTS BGKARBITREQS;"
        dropResString = "DROP TABLE IF EXISTS BGKARBITRESULTS;"
        reqString = "CREATE TABLE BGKARBITREQS(TAG TEXT NOT NULL, RANK INT NOT NULL, REQ INT NOT NULL, TEMPERATURE REAL, DENSITY_0 REAL, DENSITY_1 REAL, DENSITY_2 REAL, DENSITY_3 REAL, ZBARS_0 REAL, ZBARS_1 REAL, ZBARS_2 REAL, ZBARS_3 REAL, MASSES_0 REAL, MASSES_1 REAL, MASSES_2 REAL, MASSES_3 REAL, REQTYPE INT);"
        resString = "CREATE TABLE BGKARBITRESULTS(TAG TEXT NOT NULL, RANK INT NOT NULL, REQ INT NOT NULL, VISCOSITY REAL, THERMAL_CONDUCT REAL, DIFFCOEFF_0 REAL, DIFFCOEFF_1 REAL, DIFFCOEFF_2 REAL, DIFFCOEFF_3 REAL, DIFFCOEFF_4 REAL, DIFFCOEFF_5 REAL, DIFFCOEFF_6 REAL, DIFFCOEFF_7 REAL, DIFFCOEFF_8 REAL, DIFFCOEFF_9 REAL, PROVENANCE INT NOT NULL);"
        gndString = "CREATE TABLE IF NOT EXISTS BGKMASSESGND(TEMPERATURE REAL, DENSITY_0 REAL, DENSITY_1 REAL, DENSITY_2 REAL, DENSITY_3 REAL, ZBARS_0 REAL, ZBARS_1 REAL, ZBARS_2 REAL, ZBARS_3 REAL, MASSES_0 REAL, MASSES_1 REAL, MASSES_2 REAL, MASSES_3 REAL, INVERSION REAL, VISCOSITY REAL, THERMAL_CONDUCT REAL, DIFFCOEFF_0 REAL, DIFFCOEFF_1 REAL, DIFFCOEFF_2 REAL, DIFFCOEFF_3 REAL, DIFFCOEFF_4 REAL, DIFFCOEFF_5 REAL, DIFFCOEFF_6 REAL, DIFFCOEFF_7 REAL, DIFFCOEFF_8 REAL, DIFFCOEFF_9 REAL, OUTVERSION REAL);"
    else:
