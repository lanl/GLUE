...
def check_zeros_trace_elements(Temperature,densities,charges,masses,box,cutoff,Teq,Trun,s_int,p_int,d_int,eps_traces):
    ...
    for s in traces_elements_index:
        ...
        write_LammpsScript(Temperature,dens,Z,m,b,box,cutoff,Teq,Trun,traces_elements_index,s_int,p_int,d_int)
    ...
    write_LammpsScript(Temperature,densities[non_traces_elements_index],charges[non_traces_elements_index],masses[non_traces_elements_index],b,box,cutoff,Teq,Trun,non_traces_elements_index,s_int,p_int,d_int)

    return species_with_zeros_densities_index
