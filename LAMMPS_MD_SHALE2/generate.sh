...
W=50                           #pore width A
T=300                          #temperature K
CDT=0.1                        #Currrent density (g/cc)

DIF=1.02 #this number can be decreased for better accuracy at the expense of more MD calls
...
#CBD=$(lammps $W $T $CDT) # run the job to estimate the bulk density corresponding to the new total density 
lammps $W $T $CDT # run the job to estimate the bulk density corresponding to the new total density 
...
cp "$W"_"$T"_"$CD"/density.profile .       #copy the final density profile to the main directory 
