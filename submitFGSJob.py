...
def getSQLFromReq(fgsInput, tag, reqNum, rank, alMode):
...
def submitFGSJobs(inputList, sqlDBPath, tag, rank, alMode=ALInterfaceMode.FGS):
    ...
    for req in inputList:
        ...
        (insString, insArgs) = getSQLFromReq(req, tag, getPersistentReqNumber(), rank, alMode)
        # And insert it
